...
# 🎙️ تحويل النص إلى voice message بصوت واقعي
def speak_to_voice(text, filename="response.ogg"):
    try:
        api_key = os.getenv("ELEVEN_API_KEY")
        voice_id = "TxGEqnHWrfWFTfGW9XjX"  # صوت: محمد
